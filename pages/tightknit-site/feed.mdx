...
and will be updated automatically [when the channel is updated](../basics/how-items-sync).
...
The default list view display setting is determined by the ["List View Display" setting in the admin feed settings](../slack-administration/channel-and-feed-settings).
