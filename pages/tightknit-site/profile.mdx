...
The **Posts** tab contains a count of the user's authored posts and a Feed containing the user's post activity in all Feeds, except unlisted Feeds.

### Comments

The **Comments** tab contains a count of the user's authored comments and a Feed containing the user's comment activity in all Feeds, except unlisted Feeds.
