...
![Polls command](/member-engagement/polls/polls-command.png)

## Creating a Poll

![Polls example](/member-engagement/polls/polls-example.png)
...
![Poll Menu](/member-engagement/polls/poll-menu.png)

### View Results

The poll creator may privately view the voting results of the poll at any time. The names of voters may be visible here, if the **Voter Responses** setting is set to _Public_ or _Confidential_.
