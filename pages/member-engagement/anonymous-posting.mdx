...
Users can send an anonymous reply to a thread by using the **Reply Anonymously** [message shortcut](/shortcuts-and-commands/message-shortcuts#tightknit-shortcuts).
