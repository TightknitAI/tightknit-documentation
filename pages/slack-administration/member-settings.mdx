...
In the `Leaderboard & Directory` modal, you can configure how members show up within the [leaderboard and directory](../tightknit-site/leaderboard-and-directory) pages.
