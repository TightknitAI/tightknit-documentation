...
Feeds can be created, edited, and unlisted from the app settings. You can find these settings in your Tightknit Slack Application under the `Feeds` section.
