...
- **Preset** - The Web Community UI display preset for the feed. This is used during feed creation to determine default values for display settings such as List View Display and Post Detail Display. The display values can be overridden in the optional settings below.

Additional optional settings:

- **Emoji Icon** - The emoji icon, such as 📡, that is displayed next to the feed name in the Web Community sidebar. If none is set, the sidebar displays a default icon.
...
- **List View Display** - The default display setting for posts in the feed list view, such as Snippet, Compact, or Card. [Read More](../web-community/feed.mdx#display-settings).
- **Post Detail Display** - The default display setting for the detail page of posts in this feed, such as Discussion or Blog. [Read More](../web-community/post.mdx#display-settings).
...
This will trigger a sync of the feed, which will pull the Description and Topic of the channel and update the feed's description and topic accordingly.
