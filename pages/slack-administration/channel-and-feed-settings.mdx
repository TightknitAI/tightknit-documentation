...
Each Feed is configured to monitor your Slack channel channel to control when and how messages are posted to the site. Feeds can be created, edited, and unlisted from the app settings. You can find these settings in your Tightknit Slack app under the `Channels & Feeds` section.
