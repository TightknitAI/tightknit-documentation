...
- **Site Slug** - This is the subdomain that will be used when you host your site on `tightknit.community`.
  ...
  <Callout type="warning" emoji="⚠️">
    ...
    all site pages that use this slug. This will break any links that have been
    shared.
  </Callout>
