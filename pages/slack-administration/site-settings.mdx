...
Within the Landing Page modal, you can configure the experience of the [Home landing page](../tightknit-site/home) of your site, including:

- **Community Description** - This is the subtitle underneath the community name.
- **Banner Image** - The Hero image banner at the top of the landing page. For the best results, please use a dark image with dimensions of at least 970 x 90. Very tall images may be clipped.

![Tightknit Site Landing Page Modal](/slack-administration/landing-page-modal.png)
