...
You can find the site settings under the **Companion Site** module in the app home. If you have not created a companion site yet, you can click the `+ Create Companion Site` button to launch the guided setup flow.

<Callout type="info">
  Currently, the Tightknit companion site is public.
</Callout>
