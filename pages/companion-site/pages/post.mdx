...
Posts are sourced from messages in Slack and are updated automatically [when the original message changes](/basics/companion-site-sync-guide).
...
![Post detail page - Discussion](/tightknit-site/post/post-detail-display-discussion.png)
...
![Post detail page - Blog](/tightknit-site/post/post-detail-display-blog.png)

#### Related Posts

Related posts are displayed in a section at the bottom of the page.

![Related Posts - Blog](/tightknit-site/post/post-detail-related-blog.png)
...
![Share button](/tightknit-site/post/post-detail-share-button.png)

Share the current Feed to your favorite socials, and let the world know about this awesome post! 😎

![Share modal](/tightknit-site/post/post-detail-share-modal.png)
...
![Embed post](/tightknit-site/post/embed-tab-post.png)
