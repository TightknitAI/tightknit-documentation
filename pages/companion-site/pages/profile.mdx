...
![Profile detail page](/tightknit-site/profiles/profile.png)
...
except unlisted Feeds. It also displays certain [profile fields](/companion-site/profiles/profile-fields) from the user's Slack profile.

<Callout>
  Want to know when a user's profile info is synced from Slack to the companion
  site? See the [Companion Site Sync Guide ](/basics/companion-site-sync-guide).
</Callout>
