...
The navbar header will contain your site logo and the call-to-action button. The logo will be the [Site Horizontal Logo](/companion-site/branding), if configured, otherwise the Site Icon alongside the name of the site.
