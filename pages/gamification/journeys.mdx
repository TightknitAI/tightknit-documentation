...
- **Scope to: Slack Channel** - for supported action types, the actions can be scoped to a specific Slack channel. Corresponding actions by a member must occur in this channel to count towards completion of the Milestone. If left blank, actions across _all_ activated channels will count towards completion of the Milestone.
