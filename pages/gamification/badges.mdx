...
<Callout type="info">
  For information on associating a Badge with Group membership, see
  [Groups](/community/groups#create-a-group).
</Callout>
...
Users can access the actions related to any of their previously earned badges, including [generating a framed profile photo](s#generate-a-framed-profile-photo).
