...
If you want to preserve your message in Slack and remove it only from the Tightknit companion site, you can use the Tightknit [message shortcut](/basics/message-shortcuts#tightknit-shortcuts).
