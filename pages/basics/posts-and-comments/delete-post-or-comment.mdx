...
If you want to preserve your message in Slack and remove it only from the Tightknit site, you can use the Tightknit [message shortcut](../message-shortcuts.mdx).
