...
Deleting a top-level Slack message will remove the corresponding post _and_ and of its comments from the Tightknit companion site.
...
<Callout type="info">
  ...
  any of its comments from the Tightknit companion site. To stop all bot post
  replies, enable Quiet Mode.
</Callout>

## Message Shortcut - Remove from Tightknit Companion Site Only

If you want to preserve your message in Slack and remove it only from the Tightknit companion site, you can use the Tightknit [message shortcut](../message-shortcuts).
