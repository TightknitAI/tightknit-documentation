...
<Callout type="info">
  Deleting the **New Post Notification Agent** reply is another way to trigger
  the removal of the post, and any of its comments, from the Tightknit companion
  site. This reply is only applicable in channels where the agent has been
  enabled in [Agent Settings](/channels-and-feeds/agent-settings).
</Callout>
