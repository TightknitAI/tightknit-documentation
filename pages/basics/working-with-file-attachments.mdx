...
Files up to 5 MB in size that are attached to Slack messages will be synced to the Tightknit site.
...
When the message a file is attached to is deleted in Slack, or is removed from the Tightknit site using the message shortcut,
the file is also removed from the Tightknit site.

You may also use the `Delete file` action in Slack. This action will only delete the file in Slack and in the Tightknit site, and the post/comment will be preserved.
