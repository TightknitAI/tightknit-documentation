...
Each time a user registers or unregisters for a Tightknit event in Slack, we send information about the registration action to your subscribed webhooks. [Read More↗](/integrations/webhooks#calendar-events)
