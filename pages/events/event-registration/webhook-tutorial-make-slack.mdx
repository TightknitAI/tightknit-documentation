...
In this tutorial, we will use [Make](https://www.make.com) with Tightknit's one-click event registration so that you get a notification in Slack each time a new user registers for your event.
