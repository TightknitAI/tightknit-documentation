...
![Permission Sets Button](/community/community-module.png)

Admins can access Permission Sets settings by clicking the `Permission Sets` button under the **Community** module section:
