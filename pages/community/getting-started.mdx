...
You can access settings related to the Community for under the **Community** section in the Tightknit App Home.
...
By default, the channel is named **`tightknit-hub`**, but you are free to rename it to anything you like in [Team Notifications](/community/notification-settings)!
