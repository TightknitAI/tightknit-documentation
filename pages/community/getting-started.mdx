...
If you are new to Tightknit and have not created a Community, follow the [guided setup flow](getting-started#create-the-community) to create one! Admins can access the Community settings under the **Community** section in the Tightknit app Home.
