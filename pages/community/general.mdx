...
- **Community Icon** - used as the user icon when the Tightknit app sends public Slack messages or DMs to members of the community

For more information on the specs and recommendations of these images, see the [Branding Guide](/branding#image-assets).

Here's an example of the **New Post Notification Agent** replying a public thread while using the branded name and icon of the community "Pinnacle Solutions".

![Tightknit New Post Notification Agent](/community/tightknit-bot-responder.png)
