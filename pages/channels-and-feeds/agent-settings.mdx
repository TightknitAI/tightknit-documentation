...
- New Post Notification Agent
- Related Discussions Agent [✨AI]
- AI Answers Agent [✨AI] (_coming soon!_)

### New Post Notification Agent

When a message is synced to the Companion Site as a post, the **New Post Notification Agent** adds a reply to the thread with a link to the post and a reminder that all further replies are synced to the site.

![New Post Notification Agent message](/channels-and-feeds/agents/post-sync-reminder-agent.png)
