...
- **Message Sync Settings** - By default, Tightknit will sync all incoming new Slack messages and replies to the Feed, starting from the time that this setting is enabled. If you do _not_ want to auto-sync messages (e.g., you prefer to manually sync select posts using the [shortcut](/shortcuts/message-shortcuts#tightknit-shortcuts)), uncheck this option.
